...
## Project Structure
    ...
    ├── ivy_league_academy_34095  # Django project configurations
...
1. Clone this repo and `cd ivy_league_academy_34095`
...
2. Clone this repo and `cd ivy_league_academy_34095`
